...
#print alpha index 10
print(alpha[10])
print(alpha[0])
print(alpha[19])
print(alpha[23]+alpha[24]+alpha[25]) #xyz
print(alpha[23:]) #xyz
print(alpha[8:11]) #ijk

#alpha[start:stop]
print(alpha[8:11])
print(alpha[-1]) #get the last item
print(alpha[-2]) #get the second to last item
#alpha[start:end:stop]
print(alpha[0:20:2])
print(alpha[:26:5])
# print(alpha[:::2]) no no
print(alpha[::-1]) #backwards
"""

#show how strings and list use the same index things
...
toy=alphaList[19]+alphaList[14]+alphaList[24]
print(toy)
print(alphaList[8:11])
print(alphaString[8:11])

#how long each item -> what is the length of the item
print(len(alphaString))
print(len(alphaList))
print(alphaList[-1])
print(alphaList[25])
print(alphaList[0])
